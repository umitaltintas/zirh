...
export const EXERCISES = {
  ...
  "leg-press": {
    ...
    step: 5, start: {erkek: "40-60 kg", kadin: "20-40 kg"},
  ...
  "leg-press-high": {
    ...
    step: 5, start: {erkek: "A gününün %70'i", kadin: "A gününün %70'i"},
  ...
  "seated-leg-curl": {
    ...
    step: 2.5, start: {erkek: "15-25 kg", kadin: "10-20 kg"},
  ...
  "leg-extension": {
    ...
    step: 2.5, start: {erkek: "20-30 kg", kadin: "10-20 kg"},
  ...
  "calf-raise": {
    ...
    step: 5, start: {erkek: "20-40 kg", kadin: "10-25 kg"},
  ...
  "chest-press-machine": {
    ...
    step: 2.5, start: {erkek: "20-30 kg", kadin: "10-15 kg"},
  ...
  "seated-cable-row": {
    ...
    step: 2.5, start: {erkek: "25-35 kg", kadin: "15-25 kg"},
  ...
  "machine-row": {
    ...
    step: 2.5, start: {erkek: "25-40 kg", kadin: "15-25 kg"},
  ...
  "shoulder-press-machine": {
    ...
    step: 2.5, start: {erkek: "15-25 kg", kadin: "7-12 kg"},
  ...
  "face-pull": {
    ...
    step: 2.5, start: {erkek: "10-15 kg", kadin: "5-10 kg"},
  ...
  "triceps-pushdown": {
    ...
    step: 2.5, start: {erkek: "15-25 kg", kadin: "7-15 kg"},
  ...
  "cable-fly": {
    ...
    step: 2.5, start: {erkek: "7-12 kg / taraf", kadin: "4-7 kg / taraf"},
  ...
  "rear-delt-fly": {
    ...
    step: 2, start: {erkek: "5-8 kg", kadin: "2-5 kg"},
  ...
  "goblet-squat": {
    ...
    step: 2, start: {erkek: "10-16 kg", kadin: "6-10 kg"},
  ...
  "back-squat": {
    ...
    step: 5, start: {erkek: "boş bar, 20 kg", kadin: "boş bar, 20 kg"},
  ...
  "db-romanian-deadlift": {
    ...
    step: 2, start: {erkek: "10-16 kg / el", kadin: "6-10 kg / el"},
  ...
  "deadlift": {
    ...
    step: 5, start: {erkek: "40-50 kg", kadin: "30-40 kg"},
  ...
  "hip-thrust": {
    ...
    step: 5, start: {erkek: "boş bar, 20 kg", kadin: "10-20 kg"},
  ...
  "walking-lunge": {
    ...
    step: 2, start: {erkek: "8-12 kg / el", kadin: "4-8 kg / el"},
  ...
  "bulgarian-split-squat": {
    ...
    step: 2, start: {erkek: "vücut ağırlığı → 8 kg / el", kadin: "vücut ağırlığı → 4 kg / el"},
  ...
  "back-extension": {
    ...
    step: 2.5, start: {erkek: "vücut ağırlığı", kadin: "vücut ağırlığı"},
  ...
  "db-bench-press": {
    ...
    step: 2, start: {erkek: "10-16 kg / el", kadin: "5-8 kg / el"},
  ...
  "barbell-bench-press": {
    ...
    step: 2.5, start: {erkek: "boş bar, 20 kg", kadin: "boş bar, 20 kg"},
  ...
  "incline-db-press": {
    ...
    step: 2, start: {erkek: "8-14 kg / el", kadin: "4-7 kg / el"},
  ...
  "overhead-press": {
    ...
    step: 2.5, start: {erkek: "boş bar, 20 kg", kadin: "15-20 kg"},
  ...
  "db-shoulder-press": {
    ...
    step: 2, start: {erkek: "8-12 kg / el", kadin: "4-6 kg / el"},
  ...
  "lateral-raise": {
    ...
    step: 2, start: {erkek: "5-8 kg", kadin: "2-4 kg"},
  ...
  "barbell-row": {
    ...
    step: 2.5, start: {erkek: "30-40 kg", kadin: "20-25 kg"},
  ...
  "pull-up": {
    ...
    step: 0, bw: true, start: {erkek: "vücut ağırlığı", kadin: "vücut ağırlığı"},
  ...
  "biceps-curl": {
    ...
    step: 2, start: {erkek: "8-12 kg", kadin: "4-6 kg"},
  ...
  "skull-crusher": {
    ...
    step: 2.5, start: {erkek: "15-20 kg", kadin: "10-12 kg"},
  ...
  "barbell-shrug": {
    ...
    step: 5, start: {erkek: "40-60 kg", kadin: "20-30 kg"},
  ...
  "hanging-leg-raise": {
    ...
    step: 0, bw: true, start: {erkek: "vücut ağırlığı", kadin: "diz çekerek başla"},
